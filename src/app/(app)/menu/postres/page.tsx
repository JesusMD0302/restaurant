...
export default function Home() {
  return (
    <div>
      <h1>postres</h1>
      {/* <div className="dark text-foreground bg-background pt-8 flex items-start">
        <Card className="h-[325px] w-[225px] border-dotted border-2 bg-transparent shadow-none border-[#EA7C69] me-4">
          <CardBody className="flex items-center h-full justify-center ">
            <BsPlus className="text-[#EA7C69]"/>
            <span className="font-medium text-[#EA7C69]">Add new dish</span>
          </CardBody>
        </Card>
        <Card isFooterBlurred radius="lg" className="border-none bg-transparent">
          <CardBody>
            <Image
              ...
              width={200}
            />
            <p className="my-4 max-w-[15ch] text-center font-medium m-auto">Spicy seasoned seafood noodles</p>
