...
const LoginUser = () => {
  ...
  return (
    <div className=''>
    <div className="flex justify-center items-center min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url('/resta.jpg')` }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="px-4 py-2 rounded-lg shadow-sm border-gray-300 focus:outline-none focus:ring focus:ring-blue-200"
              />
            </div>
            <div className="mb-6">
